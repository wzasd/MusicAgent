...
【规则】
1. intent_type 只能是以下之一：search, search_by_lyrics, search_by_theme, recommend_by_mood, recommend_by_genre, recommend_by_artist, recommend_by_favorites, recommend_by_activity, general_chat
